  ...
  private static void parseDirAndSubDir(String dir) {
    ...
    while (dp.hasNext()) {
      ...
      if (new File(dir+fn).isDirectory()) {
        ...
        try {
          pw = kegg.KeggParser.parse(dir+fn);
        ...
        for (int i=0; i<pw.size(); i++) {
          ...
          if (KEGG2GraphML.lastFileWasOverwritten) { // Datei war oben noch nicht da, später aber schon => ein anderer prezess macht das selbe bereits.
