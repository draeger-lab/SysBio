...
public class KeggAdaptor {
  ...
  private void retrieveVariousIDs(String in_id) { // z.B. "hsa:8491"
    String key[] = new String[]{"NCBI-GeneID:","UniProt:", "Ensembl:"}; // Siehe 2 Zeilen drüber
   ...
   *                 [EC:2.7.11.1]
   *  => Hier wäre startWith "NAME" oder "DEFINITION". (Case insensitive)                
  ...
  public static String extractInfo(String completeString, String startsWith, String endsWith) {
    ...
    if (pos<0) {
      ...
      // Prüfen ob zeichen ausser \t und " " zwischen \n und pos. wenn ja => abort. (Beispiel: "  AUTHOR XYZ" möglich.)
