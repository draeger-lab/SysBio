...
public class FormatIdentification {
  ...
  /**
   * Liest soviele bytes aus dem stream, wie für identifikation nötig, identifiziert und resettet den Stream wieder.
   */
  ...
  public static void main(String[] args) {
    ...
    for (String filename: test){
      filetype.FormatDescription desc = FormatIdentification.identify(new File(filename));
