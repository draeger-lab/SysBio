...
import filetype.bzip2.CBZip2InputStream;
import filetype.tar.TarEntry;
import filetype.tar.TarInputStream;
...
public class ZIPUtils {
  ...
  public static String prefixOfOutFile=""; // Ermöglicht entpacken in einen spezifischen Pfad.
  ...
  public static void ZIPunCompress(String[] INfilenames, boolean silentMode) throws IOException {
    for (int i=0; i< INfilenames.length; i++) {
      ...
      while ((ze = in2.getNextEntry()) != null) {
        ...
        //BufferedWriter out = new BufferedWriter(new FileWriter(prefixOfOutFile+ze.getName())); // TUT NICHT FÜR BINÄRDATEIEN!!!
  ...
  public static void GZIP() throws IOException {
    // Müsste noch in compress und uncompress getrennt werden, bei Bedarf!
  ...
  public static void main(String[] args) {
    ...
    String myDir = "Z:\\workspace\\dipl\\tmpTestFiles\\Matritzen\\neu\\NEU ANNOTIERT\\allerneuste/"; // mit "/" abschließend!
    String[] files = new File(myDir).list();
 // XXX: PWMANNOTATIONS.JAVA DANACH AUF DIE GEMERGTEN PWMS AUSFÜHREN!!!, AN ARAB_ANNOT DENKEN!
