 ...
 * ACHTUNG: Nur die Methoden, welche ich benötige implementiert. Nur add(T), addAll, indexOf(T) und contains(T).
 *
 * @param <T>
 */
public class SortedArrayList<T> extends java.util.ArrayList<T>{
  ...
  /**
   * Achtung: bei Not Found gibt er manchmal "0" zurück!! Das muss gesondert gecheckt werden.
   */
  @SuppressWarnings("unchecked")
