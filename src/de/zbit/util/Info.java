 ...
 * @author wrzodek
 * 
 * @param <IDtype> Type of the id (int or string,...) must be comparable.
 * @param <INFOtype> Type of information (arbitrary)
 */
...
public class Info<IDtype extends Comparable, INFOtype> implements Comparable, Serializable {
  ...
  public INFOtype getInformation() {
    /*
     * Do NOT call this function internaly, since it remembers how often you use it. 
     */
    if (timesInfoAccessed!=Integer.MAX_VALUE) timesInfoAccessed++;
    return information;
  }
  ...
  public int compareTo(Object o) {
    if (o instanceof Info) {
      ...
      } catch (Exception e) {} // Invalid cast
  ...
  public boolean equals(Object obj) {
    try {
      if (obj instanceof Info) return equals((Info<IDtype, INFOtype>)obj);
    } catch (Exception e) {} // Other subtypes. Wrong cast!
    return super.equals(obj);
  }
  
  public boolean equals(Info<IDtype, INFOtype> o) {
    if (o.getIdentifier().equals(this.getIdentifier()) && o.information.equals(this.information)) return true;
    return false;
  }
  
  @Override
  public String toString(){
    return "@InfoObject. ID: '" + getIdentifier().toString() + "'. Information: '" + information.toString() + "'.";
  }
