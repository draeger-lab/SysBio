 ...
 * simpler
 * and avoids exceptions when storing the content in an XML file. Furthermore,
 * it
 * also allows access to the default value collection, which is not possible in
 * its super class.
 * 
...
public class SBProperties extends Properties {
     ...
     * and
     * values. Furthermore, this also ensures that properties can always be
     * found
