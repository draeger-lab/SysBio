/*
 * $Id:  PubChemCompound2CompoundIDMapper.java 15:22:17 rosenbaum $
 * $URL: PubChemCompound2CompoundIDMapper.java $
 * ---------------------------------------------------------------------
...
/**
 * Maps PubChem compound ID to Compound IDs.
...
public class PubChemCompound2CompoundIDMapper extends AbstractMapper<String,Integer> {
  ...
  public PubChemCompound2CompoundIDMapper() throws IOException {
  	this(null);
  }
	...
	public String getMappingName() {
		return "PubChemCompound2CompoundID";
	}
