...
public class ASTNodePanel extends JPanel {
     ...
     * @throws IOException
     */
    public ASTNodePanel(ASTNode node, boolean namesIfAvailable, boolean useJTextFiled, Renderer renderer) throws SBMLException, IOException {
		super();
		LayoutHelper lh = new LayoutHelper(this);
		lh.add(new JPanel(), 0, 0, 1, 1, 0, 0);
		lh.add(createPanel(node,namesIfAvailable, useJTextFiled, renderer), 1, 0, 1, 1, 0, 0);
	 ...
	 * @return
	 */
	private Component createPanel(ASTNode node, boolean namesIfAvailable, boolean useJTextFiled, Renderer renderer) {
		...
		if (renderer == null) {
			preview = new JPanel();
			((JPanel) preview).setBorder(BorderFactory.createLoweredBevelBorder());
		}
		else {
