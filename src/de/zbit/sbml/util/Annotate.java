...
public class Annotate {
  ...
  public static void annotate(Species spec, String ko_id,
    ...
    String kgMiriamEntry = KeggInfos.getMiriamURNforKeggID(ko_id);//getMiriamURIforKeggID(ko_id);
  ...
  private static void appendAllGOids(String goIDs, CVTerm mtGoID) {
    for (String go_id : goIDs.split(" ")) {
      ...
      String urn = KeggInfos.miriam_urn_geneOntology; //getGo_id_with_MiriamURN(go_id);
