 ...
 * customized calling the {@link #setPreviewString(String)} method.
 * 
 * In the main text field, the default font is used to display the font name.
 * It is editable and supports auto completion.
 * 
 * The last {@code n} selected fonts can be shown on the top
 * by calling {@link #setRecentFontsCount(int)}.
 * 
 ...
 * @version $Rev$
 */
public class JFontChooserComboBox
extends JComboBox
implements ItemListener
{
  
  private int previewFontSize;
  private String previewString = "AaBbCcYyZz";
  ...
  /**
   * Creates a new {@link JFontChooserComboBox}.
   */
  public JFontChooserComboBox()
  {
  ...
  public String getSelectedFontName() {
    ...
    return font != null ? font.getFontName() : null;
  }
  ...
  public Font getSelectedFont() {
    ...
    return item != null ? ((Item) getSelectedItem()).font : null;
  }
    ...
    extends PlainDocument
    {
          ...
          throws BadLocationException
      {
        if (s != null && !"".equals(s))
        {
          ...
          if (s2 != null) {
            JFontChooserComboBox.this.setSelectedItem(s2);
          }
      ...
      @Override public void remove(int i, int j) throws BadLocationException
      {
        ...
        if (s != null) {
          JFontChooserComboBox.this.setSelectedItem(s);
        }
        try
        {
