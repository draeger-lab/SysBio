...
public class ScrollablePanel extends JPanel implements Scrollable,
  ...
  private static final long serialVersionUID = -6705703630060676317L;
   ...
   * laying out the children ScrollableSizeHint.STRETCH - return "true" when the
   * viewport height is greater than the height of the panel, "false" otherwise.
   * 
   ...
   * laying out the children ScrollableSizeHint.STRETCH - return "true" when the
   * viewport width is greater than the width of the panel, "false" otherwise.
   * 
   ...
   *        the amount as the scrollable amount
   * @param amount a value used with the IncrementType to determine the
   *          scrollable amount
   */
  public void setScrollableBlockIncrement(int orientation, IncrementType type,
                                          int amount) {
   ...
   *          scrollable amount
   */
  public void setScrollableUnitIncrement(int orientation, IncrementType type,
                                         int amount) {
    IncrementInfo info = new IncrementInfo(type, amount);
