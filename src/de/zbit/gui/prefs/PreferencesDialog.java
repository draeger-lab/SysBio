/*
 * $Id: PreferencesDialog.java 1408 2017-06-12 22:06:51Z lbuchweitz $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn-path/SysBio/trunk/src/de/zbit/gui/prefs/PreferencesDialog.java $
 * ---------------------------------------------------------------------
  ...
  public void itemStateChanged(ItemEvent e) {
    if(e.getSource() instanceof OptionCheckBox) {
      ...
      if(cb.getName().equals("CHOOSE_OWN_NODE_COLORS") && (Boolean)cb.getCurrentValue()) {
        ...
        allPrefsPanel.restoreDefaultColors();
      }
    }
