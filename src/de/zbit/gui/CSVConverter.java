...
/**
 * This {@link CSVConverter} tries to map the head entries in a given CSV file
 ...
 * {@link String}s). Furthermore, this {@link CSVConverter} provides several
...
public class CSVConverter {
	...
	public static void main(String[] args) throws IOException {
		if (args.length > 0) {
			...
			CSVConverter converter = new CSVConverter(args[args.length - 1],
					expectedHead);
			System.out
	 ...
	 * @throws IOException
	 */
	public CSVConverter(Component parent, boolean hideExactColumnNames,
	 ...
	 * @throws IOException
	 */
	public CSVConverter(Component parent, String pathname,
	 ...
	 * @throws IOException
	 */
	public CSVConverter(String pathname, String... expectedHead)
			throws IOException {
