 ...
 * 
 * <p>NOTE: All KEYS are also stored in the resources file
 * "de.zbit.graph.locales.Labels.xml". Also modify this file
 * when modifying the Strings. Furthermore J.Supper has adapted
 * his GePS to those Strings, so better LEAVE THEM AS THEY ARE!</p>
 * 
