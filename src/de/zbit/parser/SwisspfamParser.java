 ...
 * 
 * 
 * Der Parser erstellt aus der urspr&uuml;nglichen Swisspfam Datei, eine Datei in folgendem Format:
 * 
 * Protein (uniprot id) \t Dom&auml;ne (Pfam id) \t startpos im Prot \t endpos im Prot \n
 * Beispiel:
