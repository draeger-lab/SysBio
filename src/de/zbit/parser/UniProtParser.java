...
public class UniProtParser {
  UniProtWrapper UniprotManagement = null;

  public UniProtParser() {
    try {
      if (new File("uniprot.dat").exists())
        UniprotManagement = (UniProtWrapper) UniProtWrapper
        .loadFromFilesystem("uniprot.dat");
    } catch (Throwable e) {
    }
    if (UniprotManagement == null)
      UniprotManagement = new UniProtWrapper(80000);
  }

  /**
   * @param all
   *          uniprot identifiers sparated with commas
   */
