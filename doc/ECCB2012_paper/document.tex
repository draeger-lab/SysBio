...
%problem
Before the release of the Qualitative Models specification (\qual, \citealp[see][]{QualSpecification}),

%see %\url{http://sbml.org/Community/Wiki/SBML\_Level\_3\_Proposals/Qualitative\_Models}
%\href{http://sbml.org/Community/Wiki/SBML_Level_3_Proposals/Qualitative_Models}
%{www.sbml.org/Community/Wiki/SBML\_Level\_3\_Proposals/Qualitative\_Models}),


it was not possible to define relations or to integrate reactions and relations in one model.
%relevance
...
\item TODO: Conversion/Control elemente nochmal zusï¿½tzlich einzeichnen?
